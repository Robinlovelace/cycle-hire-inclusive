...
```{r bikeshare-resi-buildings, fig.cap="Method for estimating the residential population with access to docking stations within 150m. Blue shade represents the population in each Output Area, buildings are in green and buildings near docking stations are in red.", out.width="70%"}
...
```{r map-am-pm-peaks, out.width="100%", fig.cap="Spatial distribution of cycle hire points of origin during the morning and afternoon peaks"}
...
```{r income-decile-am-pm-beeswarm, fig.cap="Boxplot showing docking station usage (y axis) by income decile of nearest residential areas (x axis, right is wealthier) during the morning (top panel, 06:00 to 10:00) and afternoon (bottom panel, 16:00 to 20:00) peaks.", out.width="70%"}
