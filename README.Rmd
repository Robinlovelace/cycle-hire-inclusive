...
We found that, contrary to the trend for increasing segregation and geographic inequalities, the usage (and inferred benefits) of the LCHS have become increasingly geographically distributed across London over time.
...
Inequalities related to BSS are directly linked to use and access, and thhe consequent benefits of accessibility -- health.
...
Similarly, @ogilvie_inequalities_2012 reported that registered users of the London scheme were more likely living in socioeconomically advantaged areas, indicating that they may also have higher disposable income.
