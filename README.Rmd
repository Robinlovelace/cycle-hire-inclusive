...
```{r, eval=TRUE, echo=TRUE}
g = lchs_check_dates(data_filtered_clean)
g
```
...
```{r global-growth, fig.cap="Growth in docked cycle hire schemes worldwide in terms of docking stations by continent.", out.width="80%", fig.pos="h"}
# file.edit("get-global-stations.R") # to reproduce this plot
...
```{r global-stations-cycles, fig.cap="Cycle hire schemes worldwide by continent, comparing number of docking stations with number of cycles.", out.width="80%", fig.pos="h"}
...
```{r cycle-hire-chart-daily, eval=TRUE, out.width="70%", fig.cap="Top: Number of cycles hired per day across the London Cycle Hire Scheme. Translucent dots represent daily counts; the black line is a monthly (30 day) rolling average; the blue line is the yearly rolling average number of hires per day. Bottom: the extent of the scheme in 2019 (see https://i.imgur.com/1rAfJgZ.gif for an animated version of the map).", fig.show='hold'}
knitr::include_graphics(c("figures/cycle-hire-chart-daily.png", "clean-figures/overview-2019.png"))
```
