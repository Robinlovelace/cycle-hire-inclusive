...
```{r global-growth, fig.cap="Growth in docked cycle hire schemes worldwide in terms of docking stations by continent. Source: [Wikipedia](https://en.wikipedia.org/wiki/List_of_bicycle-sharing_systems) data, March 2020.", out.width="80%", fig.pos="h", eval=TRUE}
...
```{r global-stations-cycles, fig.cap="Cycle hire schemes worldwide by continent, comparing number of docking stations with number of cycles. Source: [Wikipedia](https://en.wikipedia.org/wiki/List_of_bicycle-sharing_systems) data, March 2020.", out.width="80%", fig.pos="h", eval=TRUE}
...
```{r cycle-hire-players, eval=TRUE, out.width="70%", fig.cap="A summary of docked and dockless bikeshare schemes operating in London. Bar height proportional to number of bikes and coloured according to the year in which the scheme was introduced. Source: [Oliver O'Brien](https://oobrien.com/2019/07/then-there-were-eight/).", fig.show='hold'}
