...
```{r cycle-hire-players, eval=TRUE, out.width="70%", fig.cap="A summary of bishare schemes operating in London. Bar height proportional to number of bikes and coloured according to the year in which the scheme was introduced.", fig.show='hold'}
